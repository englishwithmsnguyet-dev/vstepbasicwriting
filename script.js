...
const nounsPracticeExtra3Data = [
    { q: "Bảo vệ môi trường là một vấn đề quan trọng.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>environmental protection</b> (n): <i style='color: #1e293b; font-weight: 600;'>việc bảo vệ môi trường</i></div><div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>important issue / important problem</b> (n): <i style='color: #1e293b; font-weight: 600;'>vấn đề quan trọng</i></div>", a: ["Environmental protection is an important issue.", "Protecting the environment is an important issue.", "Environmental protection is an important problem."] },
    { q: "Ông ấy là một giáo viên tiếng Anh rất giỏi.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>a very good English teacher</b> (n): <i style='color: #1e293b; font-weight: 600;'>một giáo viên tiếng Anh rất giỏi</i></div>", a: ["He is a very good English teacher.", "He is a great English teacher."] },
    { q: "Việc học tiếng Anh mang lại nhiều lợi ích tuyệt vời.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>learning English</b> (n): <i style='color: #1e293b; font-weight: 600;'>việc học tiếng Anh</i></div><div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>many great benefits</b> (n): <i style='color: #1e293b; font-weight: 600;'>nhiều lợi ích tuyệt vời</i></div>", a: ["Learning English brings many great benefits.", "Learning English brings a lot of great benefits."] },
    { q: "Thành phố này có một hệ thống giao thông công cộng hiện đại.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>a modern public transportation system</b> (n): <i style='color: #1e293b; font-weight: 600;'>hệ thống giao thông công cộng hiện đại</i></div>", a: ["This city has a modern public transportation system.", "This city has a modern public transport system."] },
    { q: "Ô nhiễm không khí là một vấn đề xã hội nghiêm trọng.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>air pollution</b> (n): <i style='color: #1e293b; font-weight: 600;'>ô nhiễm không khí</i></div><div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>a serious social problem / issue</b> (n): <i style='color: #1e293b; font-weight: 600;'>vấn đề xã hội nghiêm trọng</i></div>", a: ["Air pollution is a serious social problem.", "Air pollution is a serious social issue."] },
    { q: "Họ đang xây dựng một trung tâm thương mại mới.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>a new shopping mall / shopping center</b> (n): <i style='color: #1e293b; font-weight: 600;'>một trung tâm thương mại mới</i></div>", a: ["They are building a new shopping mall.", "They are building a new shopping center."] },
    { q: "Cô ấy cần một vài lời khuyên hữu ích về việc học.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>some useful advice</b> (n): <i style='color: #1e293b; font-weight: 600;'>một vài lời khuyên hữu ích (danh từ không đếm được)</i></div>", a: ["She needs some useful advice on studying.", "She needs some useful advice about studying."] },
    { q: "Sự phát triển kinh tế nhanh chóng tạo ra nhiều cơ hội việc làm mới.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>rapid economic development / growth</b> (n): <i style='color: #1e293b; font-weight: 600;'>sự phát triển kinh tế nhanh chóng</i></div><div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>many new job opportunities</b> (n): <i style='color: #1e293b; font-weight: 600;'>nhiều cơ hội việc làm mới</i></div>", a: ["Rapid economic development creates many new job opportunities.", "Rapid economic growth creates many new job opportunities."] },
    { q: "Chúng ta cần những phương pháp giảng dạy hiệu quả.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>effective teaching methods</b> (n): <i style='color: #1e293b; font-weight: 600;'>những phương pháp giảng dạy hiệu quả</i></div>", a: ["We need effective teaching methods."] },
    { q: "Việc tham gia các hoạt động ngoại khóa là một trải nghiệm tuyệt vời.", hint: "<div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>joining / participating in extracurricular activities</b> (n): <i style='color: #1e293b; font-weight: 600;'>việc tham gia các hoạt động ngoại khóa</i></div><div style='color: #334155;'>• <b style='color: var(--primary-color); font-weight: 800;'>a wonderful experience</b> (n): <i style='color: #1e293b; font-weight: 600;'>một trải nghiệm tuyệt vời</i></div>", a: ["Joining extracurricular activities is a wonderful experience.", "Participating in extracurricular activities is a wonderful experience.", "Joining extracurricular activities is a great experience."] }
];
                                ...
                                ${q.hint ? `
                                    <div style="margin-bottom: 12px;">
                                        <button onclick="const h = document.getElementById('noun_extra3_hint_${idx}'); h.style.display = (h.style.display === 'none' || !h.style.display) ? 'block' : 'none';" style="background: none; border: none; color: #0284c7; font-size: 0.95rem; cursor: pointer; padding: 0; display: flex; align-items: center; gap: 4px; font-weight: 600;">
                                            <span style="font-size: 1.1rem">💡</span> Xem gợi ý danh từ
                                        </button>
