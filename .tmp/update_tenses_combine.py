...
def update():
    ...
    # Locate the "3. Sự thay đổi của Động từ" item in verbsTheoryData
    ...
    new_content = """        title: "🔄 3. Sự thay đổi của Động từ (Verb Transformations)",
        content: `
                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        ...
                        <div style="background: white; border-radius: 8px; border: 1px solid #ffedd5; overflow: hidden;">
                            ...
                            <div style="padding: 12px 16px; display: flex; flex-direction: column; gap: 8px;">
                                ...
                                <div>• <b>He / She / It / Danh từ chung số ít / Danh từ không đếm được / Đại từ bất định...</b> ➡️ Động từ <b style="color: #ea580c;">thêm s/es</b></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        <div style="background: white; border-radius: 8px; border: 1px solid #ccfbf1; overflow: hidden;">
                            <div style="padding: 12px 16px; display: flex; flex-direction: column; gap: 8px;">
                                ...
                                <div>• <b>He / She / It / Danh từ số ít / Không đếm được...</b> + <b style="color: #0d9488;">is</b> + V-ing</div>
                                <div>• <b>You / We / They / Danh từ số nhiều...</b> + <b style="color: #0d9488;">are</b> + V-ing</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="background: #f8fafc; border-radius: 12px; border: 1px solid #e2e8f0; padding: 16px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        <div style="background: white; border-radius: 8px; border: 1px solid #e2e8f0; overflow: hidden;">
                            ...
                            <div style="padding: 12px 16px; display: flex; flex-direction: column; gap: 8px;">
                                <div>• <b>I / He / She / It / Danh từ số ít / Không đếm được...</b> ➡️ đi với <b style="color: #475569;">was</b></div>
                                <div>• <b>You / We / They / Danh từ số nhiều...</b> ➡️ đi với <b style="color: #475569;">were</b></div>
                            </div>
                        </div>
                        <div style="background: white; border-radius: 8px; border: 1px solid #e2e8f0; overflow: hidden;">
                ...
                <div style="background: #fdf4ff; border-radius: 12px; border: 1px solid #fae8ff; padding: 16px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        <div style="background: white; border-radius: 8px; border: 1px solid #fae8ff; overflow: hidden;">
                            <div style="padding: 12px 16px; display: flex; flex-direction: column; gap: 8px;">
                                <div>• <b>I / You / We / They / Danh từ số nhiều...</b> + <b style="color: #c026d3;">have</b> + V3/ed</div>
                                <div>• <b>He / She / It / Danh từ số ít / Không đếm được...</b> + <b style="color: #c026d3;">has</b> + V3/ed</div>
                            </div>
                        </div>
                    </div>
                </div>
